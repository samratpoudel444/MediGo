  ...
  return (
    <div className='md:mx-10'>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-25 my-10 mx-10 text-sm'>
            {/* --------left side--------- */}
            <div>
                <img onClick={()=>navigate('/home')} className='mb-2 w-40' src={scope} alt="" />
            ...
            <div>
                ...
                <ul className='flex flex-col gap-2 text-black '>
                    <li> <p onClick={()=>navigate('/home')} className='hover:text-xl hover:text-[#5f6FFF]'>Home</p> </li>
                    <li><p onClick={()=>navigate('/about')} className='hover:text-xl hover:text-[#5f6FFF]'>About us</p></li>
                    <li> <p onClick={()=>navigate('/contact')} className='hover:text-xl hover:text-[#5f6FFF]'>Contact us</p> </li>
                    <li><p className='hover:text-xl hover:text-[#5f6FFF]'>Privacy policy</p></li>
