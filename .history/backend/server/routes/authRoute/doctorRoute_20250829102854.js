...
import { getAllPatientByAge } from "../../controllers/doctorController/getDoctorPatientByAge.js";

const doctorRouter = express.Router();

doctorRouter
  .route("/getPatientByAge")
  .get(authMiddleware, isDoctor, getAllPatientByAge);
...
doctorRouter
  ...
  .get(authMiddleware, isDoctor, getDetails);
doctorRouter
