...
import listAllRemainder from "../controllers/RemainderController/deleteRemainder.js";
...
remainderRoute
  .route("/createRemainder")
  .post(authMiddleware, isPatient, listAllRemainder);

remainderRoute
  .route("/createRemainder")
  .post(authMiddleware, isPatient, createRemainder);
