...
export const addPharmacy= async(req, res, next)=>
{
    try{
         ...
         const checkIfPharmacyLiscenseExist = await PharmacyTable.findOne({
           licenseNo: req.body.licenseNo,
         });

         if (checkIfPharmacyLiscenseExist) {
           return next({ code: 401, message: "provided liscense No already exist" });
         }
