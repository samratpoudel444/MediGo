...
PriorityQueue.prototype.compare = function (a, b) {
  if (a.visitTypePriority !== b.visitTypePriority) {
    return a.visitTypePriority - b.visitTypePriority; // lower number = higher priority
  }
  if (a.age !== b.age) {
    return b.age - a.age; // older age = higher priority
  }
  return a.arrivalTime - b.arrivalTime; // earlier time = higher priority
};
