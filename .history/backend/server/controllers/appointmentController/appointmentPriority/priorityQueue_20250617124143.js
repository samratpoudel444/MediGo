...
function createPriorityQueue() {
  ...
  function compare(a, b) {
    ...
    // Step 3: If arrivalTime is set, sort by it (earlier is better)
    // If arrivalTime not set, treat as equal
  ...
  // New function to assign arrival times based on priority order
  function assignArrivalTimes() {
    const baseHour = 10; // start time 10:00
    queue.forEach((appt, index) => {
      // Create a Date for today with hour = baseHour + index, minutes = 0
