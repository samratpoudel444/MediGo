    ...
    data.forEach(async (queue, index) => {
      if (queue) {
         console.log("the queue is", queue)
             ...
             const a= await AppointmentTable.findOne(
               {
             ...
             console.log(queue.patientId);
             console.log(queue.doctorId);
             console.log(queue.appointmentDate);
             console.log(queue.Age);
             console.log(queue.reason);
             console.log(queue.appointmentType);
