  ...
  data.forEach((value) => {
    q.enqueue(
      createAppointment(
        ...
        value.appointmentDate, // keep string here
        value.doctorId
      )
    );
  });
...
function createPriorityQueue() {
  ...
  function compare(a, b) {
    ...
    // Normalize appointmentType string to lowercase for matching keys
    const priorityA =
