...
function createPriorityQueue() {
  ...
  function printQueue() {
    queue.forEach((a, i) => {
      console.log(
        `${i + 1}. PatientID: ${a.patientId}, Type: ${a.appointmentType}, Age: ${a.Age}, ArrivalTime: ${a.arrivalTime}, TimeSlot: ${a.timeSlot}, DoctorID: ${a.doctorId}, AppointmentDate: ${a.appointmentDate.toDateString()}`
      );
    });
  }
