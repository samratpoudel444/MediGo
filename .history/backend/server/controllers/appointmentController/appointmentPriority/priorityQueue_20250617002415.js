export const priorityQueueAlgo= async()=>
{
}
...
q.enqueue(
  createAppointment("Alice", 59, new Date("2025-06-01T10:00:00"), 2, "fdsfsf")
);
q.enqueue(
  createAppointment("Bob", 59, new Date("2025-06-01T09:00:00"), 1, "dsad")
);
