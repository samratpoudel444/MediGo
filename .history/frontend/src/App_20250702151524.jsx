      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRole={["Admin"]} />}>
          <Route element={<AdminLayout />}>
            <Route path="admin/ShowUsers" element={<ShowAllUsers />} />
            <Route path="admin/ShowDoctors" element={<ShowAllDoctors />} />
            <Route path="adminCreateDoctor" element={<CreateDoctor />} />
        ...
        <Route element={< DoctorPage/>}>
          <Route path="/doctor/dashboard" element=""></Route>
        </Route>
