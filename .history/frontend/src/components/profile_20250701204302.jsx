...
const Profile = () => {
  ...
  return (
    <div className="flex flex-row gap-16 items-start justify-center mt-20 px-24 py-12 bg-white rounded-xl hover:shadow-md max-w-6xl mx-auto">
      {/* Profile Image & Name */}
      ...
      <div className="flex flex-col w-2/3 items-start justify-start gap-3">
        ...
        <div className="flex gap-10 mt-10">
          <button className="border rounded px-3 py-2 bg-sky-500 font-bold text-white hover:opacity-50">
