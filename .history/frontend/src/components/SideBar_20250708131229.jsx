<FontAwesomeIcon icon="fa-regular fa-user-doctor-message" />;
        ...
        <nav className="flex-1 p-4 lg:p-6 overflow-y-auto">
          <div className="space-y-3 lg:space-y-4">
            {menuItems.map((item, index) => (
              ...
              >
                <a className="flex items-center justify-center lg:justify-start gap-3 lg:gap-4 text-lg lg:text-xl font-medium">
