    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-wrap justify-center mt-10 gap-40">
        <div className="max-w-md w-full">
          <h2 className="text-3xl font-bold text-center mb-6">Upload Prescription</h2>
            ...
            <div className="flex gap-5">
              <button
                ...
                className={`w-full rounded-md py-3 font-bold text-white ${
                  !file || mutation.isLoading ? "bg-gray-400" : "bg-green-500 hover:bg-green-600"
                }`}
              >
                Upload
              </button>
              <button
                ...
                className={`w-full rounded-md py-3 font-bold text-white ${
                  mutation.isLoading ? "bg-gray-400" : "bg-red-500 hover:bg-red-600"
                }`}
              >
                Clear
              </button>
          ...
          <div className="w-full max-w-4xl p-4 bg-green-100 rounded-md">
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {Object.entries(mutation.data.extractedText).map(([key, value]) => (
                    <TableRow key={key}>
