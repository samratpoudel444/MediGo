...
const PrescriptionUpload = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Row layout for Upload + Image */}
      <div className="flex flex-row flex-wrap justify-center items-start gap-10 px-8 mt-10">
        {/* Upload Section */}
        ...
        {/* Prescription Format Image */}
        <div className=" py-16 h-full w-full max-w-sm">
          <PrescriptionImage />
        </div>
      </div>

      {/* Column layout for success or error messages */}
