...
const GetAllApprovedAppointments = () => {
  ...
  if (isError) {
   ...
   const handleChat = (doctorFirstName, doctorLastName, doctorId) => {
     navigate("/chat", {
       state: {
         setSelectedUser: {
   ...
   console.log("the data us ", appointments);
      ...
      <Table>
        <TableHead>
          <TableRow sx={{ backgroundColor: "#f0f0f0" }}>
            ...
            <TableCell>Doctor Namw</TableCell>
        ...
        <TableBody>
          {appointments.map((app, index) => (
            ...
            >
              ...
              <TableCell>{app.doctorId.firstName}</TableCell>
              ...
              <button
                ...
                onClick={() =>
                  handleChat(
                    app.doctorId.firstName,
                    app.doctorId.lastName,
                    app.doctorId._id
                  )
                }
              >
                {app.appointmentCompleted ? "Make Chat" : "Disabled"}
              </button>
            </TableRow>
          ))}
        </TableBody>
