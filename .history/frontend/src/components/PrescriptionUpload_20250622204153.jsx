    ...
    <div className="min-h-screen 0">
      ...
      <div className="max-w-md mx-auto mt-20 p-8 ">
        ...
        <form onSubmit={handleUpload} className="space-y-6">
          <div
            className={`flex flex-col items-start justify-center border-4 border-dashed rounded-md cursor-pointer
              ${
                dragActive
          ...
          {/* Removed the preview below since it's now inside the box */}
