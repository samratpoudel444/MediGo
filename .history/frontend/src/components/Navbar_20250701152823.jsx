...
const Navbar = () => {
  ...
  return (
    <nav className="relative bg-white w-full h-[80px] px-4 text-white font-bold text-xl overflow-visible">
      ...
      {/* Profile Button */}
      <div className="absolute -top-[-22px] right-[20px] z-20 flex flex-col justify-center align-center gap-3">
        <Button
        ...
        {dropDown && (
          <div className="bg-gray-500 h-20 w-60 flex flex-col gap-3">
