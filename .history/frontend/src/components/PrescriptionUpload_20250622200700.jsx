...
const PrescriptionUpload = () => {
  ...
  return (
    <div  className={`w-[300px] h-[200px] border-2 rounded-xl flex flex-col justify-center items-center cursor-pointer transition ${
        dragActive ? 'border-blue-400 bg-blue-50' : 'border-dashed border-gray-300'>
      <Navbar />
      <div style={{ padding: "2rem" }} className="flex flex-col items-right mx-10 mt-16 justify-center w-1/2">
