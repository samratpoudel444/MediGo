      ...
      >
        ...
        <div className="border">
          <form onSubmit={handleUpload}>
            <input type="file" accept="image/*" onChange={handleFileChange} className="text-2xl border "/>
            <br />
            <br />
            <button type="submit" disabled={mutation.isLoading} className=" bg-green-400 px-10 py-3 rounded hover:opacity-90 text-xl fontt-bold">
