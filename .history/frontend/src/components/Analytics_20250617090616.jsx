...
const Analytics = () => {
  ...
  const ChartBlock = ({ title }) => (
    <div className=" flex flex-col flex-2 items-center justify-center w-1/2 h-full">
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="flex py-10 h-[50%]">
        <ChartBlock title="Users Associated With Medigo" className="w-[200px]" />
