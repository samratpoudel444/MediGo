...
const PrescriptionUpload = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-4xl font-bold align-center">Upload Prescription</h2>

        <div className="border">
          <form onSubmit={handleUpload}>
            <input type="file" accept="image/*" onChange={handleFileChange} className="text-2xl"/>
            <br />
            <br />
            <button type="submit" disabled={mutation.isLoading} className=" bg-green-400 px-5 py-3 rounded hover:opacity-90 text-2xl font-bold">
