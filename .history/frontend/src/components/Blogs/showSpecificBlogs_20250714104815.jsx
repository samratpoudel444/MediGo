...
const ShowSpecificBlogs = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="w-full flex justify-center mt-8 h-200">
        <img
          className="w-1/2 h-2/3 rounded-lg shadow-md"
          src={data?.picture}
          alt="Blog"
        />
      </div>

      <div className="mt-10 w-full flex justify-center px-6 md:px-20">
