              ...
              {Array.isArray(data) &&
                data.map((value, index) => (
                  <TableRow key={value._id || index}>
                    ...
                    <TableCell>
                      redredredredredredredredredredredredred red red red red
                      redredredredredredredredredredredredredredredredredredredredredredredredredredredredredredredredred
                    </TableCell>
                    <TableCell>
                      <img
                        src={value.picture}
