...
const Analytics = () => {
  ...
  return (
    <div className="w-[80vw] grid grid-col-2">
        <div className="w-[35rem] rounded-lg shadow-lg bg-white p-6 border border-gray-300 hover:shadow-xl transition-shadow duration-300 mt-6">
          <ChartBlock
