...
const CardSectionCard = ({
  title = "Appointment",
  description = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Error qui dolore placeat totam minima harum mollitia vero. Perspiciatis maxime. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officiis",
      ...
      >
        <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
          <Button
            ...
            whileHover={{ boxShadow: "0 4px 20px rgba(66, 203, 245, 0.3)" }}
          >
            {buttonText}
          </Button>
        </motion.div>
