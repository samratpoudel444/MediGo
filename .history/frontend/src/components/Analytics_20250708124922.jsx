      ...
      <div className="flex flex-row gap-6">
        {cardData.map((item, index) => (
          <div
            ...
            className="flex items-center h-40 gap-6 p-6 bg-white rounded-xl shadow-sm hover:shadow-md 
  transition-all duration-300 border border-gray-100 cursor-pointer 
  hover:border-blue-100 hover:scale-[1.02] group"
          >
            <div>{item.icon}</div>
