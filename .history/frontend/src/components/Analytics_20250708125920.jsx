...
const Analytics = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-col gap-6 h-[500px]">
        {/* Chart Section - Takes remaining space */}
        <div className="flex-1 min-h-[4350px] lg:min-h-full">
          <ChartBlock
        ...
        <div className="w-full lg:w-96 flex flex-row gap-6">
          {cardData.map((item, index) => (
            <motion.div
              key={index}
              className={`flex flex-col p-6 rounded-xl shadow-md cursor-pointer text-white ${item.color} hover:opacity-90 transition-opacity h-full`}
