...
const Analytics = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 h-22 bg-gray-300 text-center">
      <motion.h1 
      ...
      <div className="flex flex-col lg:flex-col gap-6 h-[400px]">
        ...
        <div className="w-full lg:w-250 flex flex-row gap-6 ml-auto ">
