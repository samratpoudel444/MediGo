...
const MessageBar = ({ userId, currentUserId }) => {
  ...
  if (isLoading) return <div className="flex justify-center p-4">Loading messages...</div>;
  if (isError) return <div className="flex justify-center p-4 text-red-500">Error loading messages</div>;
