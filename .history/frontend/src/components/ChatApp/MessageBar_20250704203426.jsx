      ...
      {messages.map((msg) => (
        <div
          ...
          className={`p-3 rounded-lg max-w-xs break-words ${
            msg.senderId === userId && msg. || msg.//import { Input } from "@mui/base/Input";
import { useQuery } from "@tanstack/react-query";
import { getSocket } from "../utils/SocketInitialize.jsx";
import axiosInstance from "../utils/AxiosInstance.jsx";
    ...
    <div className="space-y-2">
      {messages.map((msg) => (
        <div
          key={msg._id}
          className={`p-3 rounded-lg max-w-xs break-words ${
            msg.senderId === userId || msg.recieverId === userId ? "bg-blue-200 ml-auto" : "bg-gray-200 mr-auto"
          }`}
        >
...
export default MessageBar;
 === userId ? "bg-blue-200 ml-auto" : "bg-gray-200 mr-auto"
          }`}
        >
          <p className="text-base leading-snug">{msg.content}</p>
        </div>
