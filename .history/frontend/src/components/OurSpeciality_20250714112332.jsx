  ...
  return (
    <div className="w-[97vw] h-[500px] bg-gray-50 flex flex-col items-center justify-around">
      ...
      <div className="w-[60%] bg-[#42cbf5] h-[60%] rounded-4xl mt-8 mb-4 flex">
        ...
        <div className="w-[40%]">
          <h1 className="text-gray-50 text-3xl mt-12">
            View Previous Prescriptions
          </h1>
          <p className="text-gray-50 mt-4">
            Easily access and review your previously saved prescriptions anytime
            and Keep track of your medical history in one convenient place.
          </p>
          <Link to="viewOldPrescription">
            <Button
