      ...
      <div className="p-4">
        <table className="table-auto w-full border border-gray-300">
          ...
          <tbody>
            ...
            <tr className="text-gray-700">
              <td className="px-10 py-2 ">1</td>
              <td className="px-1 py-2 ">John</td>
              <td className="px-6 py-2 ">Doe</td>
              <td className="px-6 py-2 ">2025-07-03</td>
              <td className="px-6 py-2 ">Checkup</td>
              <td className="px-6 py-2 ">In-person</td>
              <td className="px-6 py-2 ">Confirmed</td>
            </tr>
