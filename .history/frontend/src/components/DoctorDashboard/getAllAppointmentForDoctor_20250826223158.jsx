...
const AppointmentsTable = () => {
  ...
  return (
    <div>
      <div className="h-22 flex justify-center items-center text-4xl font-bold bg-gray-300">
        All Appointments
      </div>
            ...
            {data
              ...
              .map((appt) => (
                <TableRow key={appt._id}>
                  ...
                  <TableCell>{appt.patientId?.email}</TableCell>
                  ...
                  <TableCell>
                    ...
                    >
                      {appt.appointmentCompleted ? "Yes" : "No"}
                    </span>
                  </TableCell>
                </TableRow>
              ))}
