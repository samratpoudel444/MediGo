...
const Buttons = [
  ...
  { name: "Patients", link: "/doctor/Patients" },
  { name: "Appointments", link: "/doctor/dashboard" },
  { name: "Messages", link: "/doctor/dashboard" },
  { name: "Write Blogs", link: "/doctor/dashboard" },
];
    ...
    <div className="w-80 h-screen border-r bg-white flex flex-col p-6 shadow-lg">
      ...
      >
        <div className="flex flex-row">
          ...
          <a className="px-2 py-5 text-xl font-bold">Samrat Poudel</a>
        </div>
