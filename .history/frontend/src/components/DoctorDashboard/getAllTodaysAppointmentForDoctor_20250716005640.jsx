...
const TodaysAppointmentsTable = () => {
  ...
  return (
    <div>
        <div className="h-22 bg-gray-300 flex justify-center items-center font-bold text-2xl">Today's Appointment</div>
              ...
              .map((appt) => {
                ...
                return (
                  <TableRow key={appt._id}>
                    <TableCell>{appt?.patientId.firstName}</TableCell>
                    ...
                    <TableCell>
                      <span
                        style={{
                          color: appt.appointmentCompleted ? "green" : "red",
                        }}
                      >
                        {appt.appointmentCompleted ? "Completed" : "Pending"}
                      </span>
                    </TableCell>
                    <TableCell>
                      {appt.appointmentCompleted ? (
                    ...
                    <TableCell>
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `../doctor/viewprescription/${appt.patientId.firstName}/${appt.patientId._id}`
                          )
                        }
                      >
                        View Prescription
