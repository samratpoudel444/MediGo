...
{
    return (
      <div className="flex flex-row items-center justify-between mt-16 px-36 py-0 rounded-lg  bg-white">
        {/* Profile Image & Name */}
        ...
        <div className="flex flex-col items-center justify-center w-1/2 text-c">
