    ...
    return (
      <div className="flex flex-col justify-center items-center">
        <div className=" flex flex-row mt-10 bg-gray-100 w-[95%] h-40 shadow-sm hover:w-0.68">
          ...
          <div className="border w-2/3 flex flex-col justify-center items-start">
            <h1> Title</h1>
            <p>
              {" "}
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
              eiusmod tempor incididunt ut labore et dolore magna <aliqua className="drfw">fsaffew</aliqua>
            </p>
          </div>
        </div>
      </div>
