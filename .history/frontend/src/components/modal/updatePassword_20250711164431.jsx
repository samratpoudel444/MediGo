        ...
        <div className="flex flex-col justify-center mt-8">
          <form className="flex flex-col justify-center items-center gap-5">
            <FormControl>
              ...
              <OutlinedInput id="previousPassword" label="Name" 
              value={form.previousPassword}/>
            </FormControl>
            <FormControl>
              <InputLabel htmlFor="component-outlined">New Password</InputLabel>
              <OutlinedInput id="newPassword" label="Name" value={form.newPassword}/>
            </FormControl>
            <FormControl>
              <InputLabel htmlFor="component-outlined">
                Confirm Password
              </InputLabel>
              <OutlinedInput id="confirmPassword" label="Name" value={form.} />
            </FormControl>
          </form>
