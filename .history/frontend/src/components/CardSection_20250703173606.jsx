	...
	return (
		<div className="w-[98vw] mt-16 bg-gray-50 h-[450px] flex items-center justify-evenly">
			<motion.div
				...
				whileTap={{ scale: 0.98 }}
			>
				Medical Prescription Syste
			</motion.div>
			{
				data.map((source,item )=>
				{
					return <CardSectionCard ket={item} title={source.title} description={source.description} buttonText={source.buttonText} link={source.link}/>
				})
			}
		</div>
	);
