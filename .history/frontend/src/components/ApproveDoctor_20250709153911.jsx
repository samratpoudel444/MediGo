...
import RemoveDoctor from "./modal/removeDoctor"; 
...
const ApproveDoctor = () => {
  ...
  if(!data) return(<div className="flex justify-center items-center mt-100 text-2xl font-bold">Approval UnAvilable</div>)
                    ...
                    <TableCell>
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          onClick={() => handleRemoveClick(row.userId)}
                        >
                          UnApprove
                        </button>
                      </div>
