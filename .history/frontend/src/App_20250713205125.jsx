...
const ShowAllDoctorDisplay = lazy(()=>import ("./components/showAllDoctorsForFront"));
const MedigoServices =lazy(()=> import("./components/ourServices"));

const GetAllAppointments = lazy(()=> import("./components/DoctorDashboard/getAllAppointments"));
