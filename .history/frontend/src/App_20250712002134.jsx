    ...
    <Router>
      ...
      >
        <Routes>
          {/* Public routes */}
          <Route
            element={<AuthLayout isAuthenticated={authState.isAuthenticated} />}
          >
          ...
          >
            <Route
              path="/admin"
              element={<AdminLayout userData={authState.userData} />}
            >
          ...
          >
            <Route
              path="/Home"
              element={<HomeComponent userData={authState.userData} />}
            />
