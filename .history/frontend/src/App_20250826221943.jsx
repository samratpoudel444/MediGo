...
const BlogListPage = lazy(() => import("./components/Blogs/BlogListPage"));
...
import ViewPrescription from "./components/DoctorDashboard/viewPrescription";
import CreateDoctorDirectly from "./components/UserDoctorRegistrationPage";




const AppointmentsTable = lazy(() =>
  import("./components/DoctorDashboard/getAllAppointmentForDoctor")
);

const TodaysAppointmentsTable = lazy(() =>
  import("./components/DoctorDashboard/getAllTodaysAppointmentForDoctor")
);
const AllPatientsTable = lazy(() =>
  import("./components/DoctorDashboard/ViewPatients")
);
const UserBlogsTable = lazy(() =>
  import("./components/DoctorDashboard/getAllBlogsOfDoctor")
);

const ViewAppointmentSchedule = lazy(() =>
  import("./components/viewAppointmentSchedules")
);

const ViewOldPrescription = lazy(() =>
  import("./components/ViewOldPrescription")
);

const ShowSpecificBlogs = lazy(() =>
  import("./components/Blogs/showSpecificBlogs")
);

const ShowAllDoctorDisplay = lazy(() =>
  import("./components/showAllDoctorsForFront")
);
const MedigoServices = lazy(() => import("./components/ourServices"));

const GetAllAppointments = lazy(() =>
  import("./components/DoctorDashboard/getAllAppointments")
);
      ...
      <Suspense>
        <Routes>
          <Route element={<AuthLayout />}>
            ...
            <Route
              path="/registerDoctorsDirectly"
              element={<CreateDoctorDirectly />}
            />
          </Route>
          <Route element={<ProtectedRoute allowedRole={["Admin"]} />}>
            ...
            <Route element={<ProtectedRoute allowedRole={["Doctor"]} />}></Route>
          ...
          <Route path="/Blog/:id" element={<ShowSpecificBlogs />} />
          <Route path="/navigatePharmacy" element={<GeolocationExample />} />
          <Route path="/services" element={<MedigoServices />} />
          <Route path="/doctors" element={<ShowAllDoctorDisplay />} />
          <Route
            path="/viewOldPrescription"
            element={<ViewOldPrescription />}
          />
          <Route
            path="/viewAppointmentSchedule"
            element={<ViewAppointmentSchedule />}
          />
          ...
          <Route element={<ProtectedRoute allowedRole={["Doctor"]} />}>
            <Route element={<DoctorPage />}>
              ...
              />
              <Route
                path="/doctor/showBlogForDoctor"
                element={<UserBlogsTable />}
              />
              <Route
              ...
              />
              <Route
                path="/doctor/getAllTodaysAppointment"
                element={<TodaysAppointmentsTable />}
              />
              <Route
                path="/doctor/getAllAppointmentForDoctor"
                element={<AppointmentsTable />}
              />
              <Route
                path="/doctor/viewprescription/:name/:id"
