...
const MedigoServices =lazy(()=> import("./components/DoctorDashboard/getAllAppointments"))   from "./components/ourServices";
    ...
    <Router>
      <Suspense>
        <Routes>
          ...
          <Route path="/services" element={<OurMedicalServices />} />
