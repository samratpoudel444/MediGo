...
function createPriorityQueue() {
  ...
  function compare(a, b) {
    ...
    // Arrival time sorting is based on assigned arrivalTime string
    if (a.arrivalTime && b.arrivalTime) {
      // Compare based on the slots array order, convert time string to index for comparison
      const slots = [
        "09:00 AM",
        "10:00 AM",
        "11:00 AM",
...
function createAppointment(
  ...
  return {
    patientId,
    patientAge,
    arrivalTime, // will be assigned later as string
    appointmentType,
